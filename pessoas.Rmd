...
source("Scripts/external_identifiers.R", local = knitr::knit_global())
```
...
```{r docentes-2024-2021, eval = has.2024.2021, results = "hide"}
# periodo
...
```{r docentes-2020-2017, eval = has.2020.2017, results = "hide"}
# periodo
...
```{r docentes-2020-tabela, eval = has.2020.2017}
table.2 <- data.frame(matrix(NA, nrow = 0, ncol = 7))
for (i in 1:dim(docentes)[1]) {
  table <- cbind(
    paste(
...
table <- table.2[ids, ]
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(table, title = "Docentes - 2020-2017")
...
```{r docentes-2020-grafico, eval = has.2020.2017}
# generate plot of docentes per information
layout(matrix(seq(1:4), ncol = 2, byrow = TRUE))
par(oma = c(2, 0.1, 2, 0.1), mar = c(1, 1, 1, 1))
...
```{r docentes-2016-2013, eval = has.2016.2013, results = "hide"}
# periodo
...
```{r docentes-2016-tabela, eval = has.2016.2013}
table.2 <- data.frame(matrix(NA, nrow = 0, ncol = 7))
for (i in 1:dim(docentes)[1]) {
  table <- cbind(
    paste(
...
table <- table.2[ids, ]
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(table, title = "Docentes - 2016-2013")
...
```{r docentes-2016-grafico, eval = has.2016.2013}
# generate plot of docentes per information
layout(matrix(seq(1:4), ncol = 2, byrow = TRUE))
par(oma = c(2, 0.1, 2, 0.1), mar = c(1, 1, 1, 1))
...
```{r docentes-2012-2010, eval = has.2012.2010, results = "hide"}
# periodo
...
```{r docentes-2012-tabela, eval = has.2012.2010}
table.2 <- data.frame(matrix(NA, nrow = 0, ncol = 7))
for (i in 1:dim(docentes)[1]) {
  table <- cbind(
    paste(
...
table <- table.2[ids, ]
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(table, title = "Docentes - 2012-2010")
...
```{r docentes-2012-grafico, eval = has.2012.2010}
# generate plot of docentes per information
layout(matrix(seq(1:4), ncol = 2, byrow = TRUE))
par(oma = c(2, 0.1, 2, 0.1), mar = c(1, 1, 1, 1))
...
```{r pos-doc-2024, eval = has.2024.2021}
# periodo
periodo <- 2021:min(as.numeric(format(Sys.Date(), "%Y")), 2024)
...
```{r pos-doc-2020, eval = has.2020.2017}
# periodo
periodo <- 2017:min(as.numeric(format(Sys.Date(), "%Y")), 2020)
...
if (dim(docentes)[1] == 0) {
  ...
  table <- table.2[ids, ]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  cat(knitr::knit_print(create_dt(table, title = "Pós-Docs - 2020-2017")))
...
```{r pos-doc-2016, eval = has.2016.2013}
# periodo
periodo <- 2013:min(as.numeric(format(Sys.Date(), "%Y")), 2016)
...
if (dim(docentes)[1] == 0) {
  ...
  table <- table.2[ids, ]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  cat(knitr::knit_print(create_dt(table, title = "Pós-Docs - 2016-2013")))
...
```{r pos-doc-2012, eval = has.2012.2010}
# periodo
periodo <- 2010:min(as.numeric(format(Sys.Date(), "%Y")), 2012)
...
if (dim(docentes)[1] == 0) {
  ...
  table <- table.2[ids, ]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  cat(knitr::knit_print(create_dt(table, title = "Pós-Docs - 2012-2010")))
  source("Scripts/fonte_sucupira.R", local = knitr::knit_global())
}
```
...
### **Inscritos** {#inscritos .tabset}

#### **Doutorado**

```{r discentes-dsc, eval = has.sucupira.files}
# dplyr::select level
...
discentes <- discentes %>% dplyr::select("Ano de Matrícula", "Nome Discente", "Nome do Orientador")
...
```{r discentes-msc, eval = has.sucupira.files}
# dplyr::select level
...
```{r historico-egressos-dsc-2024, eval = has.2024.2021}
# periodo
periodo <- 2021:min(as.numeric(format(Sys.Date(), "%Y")), 2024)
...
# filter students
egressos <- egressos[stringr::str_detect(egressos$`Nível Discente`, course.level), ]
...
# drop columns (NO SUPERVISOR FOR UNDERGRAD STUDENTS)
egressos <- egressos %>% dplyr::select("Data Situação", "Nome Discente", "Nome do Orientador")
...
if (dim(egressos)[1] != 0) {
  table <- egressos %>% dplyr::arrange(
    desc(egressos$'Data Situação'),
    egressos$'Nome Discente'
    )
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Egressos - Doutorado")
} else {
  cat("*Sem dados para exibir*")
}
...
```{r historico-egressos-msc-2024, eval = has.2024.2021}
# periodo
periodo <- 2021:min(as.numeric(format(Sys.Date(), "%Y")), 2024)
...
if (dim(egressos)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Egressos - Mestrado")
} else {
  cat("*Sem dados para exibir*")
}
...
```{r historico-egressos-dsc-2020, eval = has.2020.2017}
# periodo
periodo <- 2017:min(as.numeric(format(Sys.Date(), "%Y")), 2020)
...
```{r historico-egressos-msc-2020, eval = has.2020.2017}
# periodo
periodo <- 2017:min(as.numeric(format(Sys.Date(), "%Y")), 2020)
...
```{r historico-egressos-dsc-2016, eval = has.2016.2013}
# periodo
periodo <- 2013:min(as.numeric(format(Sys.Date(), "%Y")), 2016)
...
```{r historico-egressos-msc-2016, eval = has.2016.2013}
# periodo
periodo <- 2013:min(as.numeric(format(Sys.Date(), "%Y")), 2016)
...
```{r historico-egressos-dsc-2012, eval = has.2012.2010}
# periodo
periodo <- 2010:min(as.numeric(format(Sys.Date(), "%Y")), 2012)
...
```{r historico-egressos-msc-2012, eval = has.2012.2010}
# periodo
periodo <- 2010:min(as.numeric(format(Sys.Date(), "%Y")), 2012)
...
# filter students
bolsistas <- bolsistas[stringr::str_detect(bolsistas$`Tipo de Trabalho de Conclusão`, course.level), ]

# filter funding
funding <- "PROSUP / Cursos Novos"
bolsistas <- bolsistas[stringr::str_detect(bolsistas$`Nome do Programa de Fomento`, funding), ]
...
if (dim(bolsistas)[1] != 0) {
  table <- bolsistas %>% dplyr::arrange(
    desc(egressos$'Matrícula'),
    egressos$'Nome do Autor'
    )
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
