...
# drop columns
discentes <- discentes %>% dplyr::select("Nível Discente", "Ano de Matrícula", "Data Matrícula", "Nome Discente", "Nome do Orientador", "Tempo em curso", "Defesa até", "País")
...
# drop columns (NO SUPERVISOR FOR UNDERGRAD STUDENTS)
discentes <- discentes %>% dplyr::select("Ano de Matrícula", "Nome Discente", "País")
