...
table.projetos <-
  data.frame(
    ...
    sucupira.df$`Natureza do Projeto de Pesquisa`,
...
```{r pp-natureza-detalhes, eval = all(has.sucupira.files, knitr::is_html_output()), echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
cat('<details>')
