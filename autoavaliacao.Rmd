...
if (!sjmisc::is_empty(table.msc)) {
  ...
  cat(knitr::knit_print(
    knitr::kable(
      ...
      full_width = TRUE,
      position = "center"
    ) %>% kableExtra::column_spec(column = 1:ncol(table.msc), width = paste0(c(0.65,0.12,0.11,0.12)*(21-3-3), "cm")) %>%
      kableExtra::column_spec(column = 1, bold = TRUE) %>%
      kableExtra::row_spec(row = 0, bold = TRUE)
  ))
...
if (!sjmisc::is_empty(table.dsc)) {
  ...
  cat(knitr::knit_print(
    knitr::kable(
      ...
      full_width = TRUE,
      position = "center"
    ) %>% kableExtra::column_spec(column = 1:ncol(table.dsc), width = paste0(c(0.65,0.12,0.11,0.12)*(21-3-3), "cm")) %>%
      kableExtra::column_spec(column = 1, bold = TRUE) %>%
      kableExtra::row_spec(row = 0, bold = TRUE)
  ))
