...
```{r destaque-visibilidade, eval = any(has.metricas.doi.sucupira, has.metricas.doi.ppg)}
# Sources
...
```{r destaque-prestigio, eval = any(has.metricas.doi.sucupira, has.metricas.doi.ppg)}
# Sources
