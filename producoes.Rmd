...
# bind sources
doi_with_altmetric <-  dplyr::bind_rows(doi_with_altmetric_artigos, doi_with_altmetric_resumos)
doi_without_altmetric <- dplyr::bind_rows(doi_without_altmetric_artigos,
                                          doi_without_altmetric_resumos)
references <- dplyr::bind_rows(references_artigos, references_resumos)
...
```{r capitulo-icons, eval = has.capitulos.ppg}
# bind sources
...
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(table, title = "Produções - Trabalho em anais de eventos científicos (¹Discente, ²Egresso, ³Docente)")
cat("**Autoria**: ¹Discente, ²Egresso, ³Docente")
