...
barplot(
  ...
  ylim = c(0, length(unique(qualis.PPG.plot)) + 3),
  col = mycolors[2],
  sub = "Programa",
  cex.names = 0.7,
  xaxt = 'n',
...
summ.table.producao <-
  cbind(
    ...
    paste0(
      formatC(
        100 - round((sum(table.2[na.omit(match(rownames(table.2), c("A1", "A2", "A3", "A4", "B1", "B2", "B3", "B4", "B5"))),], na.rm = FALSE) / sum(table.2, na.rm = FALSE) * 100), 0),
        format = "d",
        digits = 0,
        big.mark = "."
      ),
    ...
    paste0(
      formatC(
        sum(table.2[na.omit(match(rownames(table.2), c("B1", "B2", "B3", "B4", "B5"))),], na.rm = FALSE) / sum(table.2, na.rm = FALSE) * 100,
        format = "d",
        digits = 0,
        big.mark = "."
      ),
    ...
    paste0(
      formatC(
        sum(table.2[na.omit(match(rownames(table.2), c("A1", "A2", "A3", "A4"))),], na.rm = FALSE) / sum(table.2, na.rm = FALSE) * 100,
        format = "d",
        digits = 0,
        big.mark = "."
      ),
