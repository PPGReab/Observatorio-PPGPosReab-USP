...
shiny::HTML("<h1>UPE | PPGCN</h1>")
shiny::HTML('<iframe id="scaled-frame" src="https://ppgcn-uff.github.io/observatorio/" style="width:100%; height:600px; border:2px solid white;"></iframe>')
...
plot.5 <- plot.5 %>% plotly::layout(
  title = list(
    text = "Idade na Titulação por Nível",
    x = 0.5,
    xanchor = 'center',
    font = list(size = '100vw', color = 'white')
  ),
