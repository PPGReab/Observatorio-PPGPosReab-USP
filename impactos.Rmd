...
try(doi_with_altmetric <- dplyr::bind_rows(doi_with_altmetric_artigos_impacto,
                                           doi_with_altmetric_resumos_impacto),
    silent = TRUE)
try(doi_without_altmetric <- dplyr::bind_rows(doi_without_altmetric_artigos_impacto,
                                              doi_without_altmetric_resumos_impacto),
    silent = TRUE)
try(references <- dplyr::bind_rows(references_artigos_impacto, references_resumos_impacto),
    silent = TRUE)
...
```{r pandemia-preprints-icons, eval = has.preprints.ppg}
# bind sources
...
```{r pandemia-capitulos-icons, eval = has.capitulos.ppg}
# bind sources
