...
# Print HTML table
if (knitr::is_html_output() && !sjmisc::is_empty(table.part4)) {
...
# Print HTML table
if (knitr::is_html_output() && any(lapply(table.3.1.2, length) > 0)) {
...
# Print HTML table
if (knitr::is_html_output() && any(lapply(table.3.2.1, length) > 0)) {
...
# Print HTML table
if (knitr::is_html_output() && !sjmisc::is_empty(table.1)) {
  table.1 <- table.1 %>%
    gtsummary::as_gt() %>%
    gt::tab_style(
      style = gt::cell_borders(
...
# Print HTML table
if (knitr::is_html_output() && !sjmisc::is_empty(table.2)) {
  table.2 <- table.2 %>%
    gtsummary::as_gt() %>%
    gt::tab_style(
      style = gt::cell_borders(
